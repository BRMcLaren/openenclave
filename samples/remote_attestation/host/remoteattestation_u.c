    ...
    size_t remote_report_size)
{
    ...
    if (remote_report)
        OE_ADD_SIZE(_input_buffer_size, (_args.remote_report_size * sizeof(uint8_t)));
    ...
    if (remote_report)
        OE_WRITE_IN_PARAM(remote_report, (_args.remote_report_size * sizeof(uint8_t)), uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             remoteattestation_fcn_id_verify_report_and_set_pubkey,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
